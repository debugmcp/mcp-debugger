        ...
        properties: { 
          ...
          dapLaunchArgs: { 
            ...
            properties: { 
              ...
              noDebug: { type: 'boolean', description: 'Run the program with the debugger disabled (standard DAP flag, default false): no breakpoint binds, no exception filter arms, no entry stop lands, and no stop ever arrives. The response warns when breakpoints, an explicit breakOnExceptions, or stopOnEntry are set alongside it' }
            },

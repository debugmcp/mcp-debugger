...
export class SessionManagerOperations extends SessionManagerData {
    async startProxyManager(session, scriptPath, scriptArgs, dapLaunchArgs, dryRunSpawn) {
    ...
    async startDebugging(sessionId, scriptPath, scriptArgs, dapLaunchArgs, dryRunSpawn) {
     ...
     */
    async isValidPythonExecutable(pythonCmd) {
     ...
     */
    async evaluateExpression(sessionId, expression, frameId, context = 'repl') {
        const session = this._getSessionById(sessionId);
...
//# sourceMappingURL=session-manager-operations.js.map
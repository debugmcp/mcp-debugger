...
import { 
  Breakpoint, SessionState, SessionLifecycleState, Variable, StackFrame, DebugLanguage, DebugSessionInfo, mapLegacyState
} from './models.js'; 
...
export class SessionManager {
  ...
  public adapterRegistry: IAdapterRegistry; // Make public for server access

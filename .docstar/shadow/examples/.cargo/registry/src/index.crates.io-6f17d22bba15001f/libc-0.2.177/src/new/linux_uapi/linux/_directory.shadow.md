# examples/.cargo/registry/src/index.crates.io-6f17d22bba15001f/libc-0.2.177/src/new/linux_uapi/linux/
...
The directory contains two complementary modules that provide a layered approach to CAN networking:

**Raw CAN Interface (`can/raw.rs`)**:
...
**J1939 Protocol Support (`can/j1939.rs`)**:
...
Both modules adhere to consistent Linux UAPI patterns:
...
The data flow follows a hierarchical structure where raw CAN provides the foundational socket interface, while J1939 extends this with automotive-specific protocol handling and network management features.

...
- Support is adapter-gated: Python, Go, Rust, C/C++, .NET, Java, and JavaScript work; Ruby is accepted with a warning and validated against the adapter's live capabilities at launch.

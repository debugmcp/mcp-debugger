# @debugmcp/codelldb-darwin-x64

Prebuilt [CodeLLDB](https://github.com/vadimcn/codelldb) 1.11.8 debug adapter binaries for **macOS x64 (Intel)**.
...
The payload is extracted unmodified from the upstream `codelldb-darwin-x64.vsix` release asset, whose sha256 digest is pinned in the repository's `packages/codelldb-common/vendor-manifest.json`.
